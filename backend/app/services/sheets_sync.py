...
def sync_now(db: Session, business: Business, integration: GoogleIntegration) -> ImportSession:
    ...
    # rejected or auto-created. Needed here too since this sync path
    # also calls validate_and_convert_rows and constructs Transaction
    # from its output the same way.
