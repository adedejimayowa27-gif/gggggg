...
def get_revenue(db: Session, business: Business, start_date: date, end_date: date) -> dict:
    ...
    revenue = db.query(revenue_expr).filter(*_period_filters(business, start_date, end_date)).scalar()
...
def get_profit(db: Session, business: Business, start_date: date, end_date: date) -> dict:
    ...
    row = (
        db.query(revenue_expr.label("revenue"), cost_expr.label("total_cost"))
...
def get_expenses(db: Session, business: Business, start_date: date, end_date: date) -> dict:
    ...
    total_cost = db.query(cost_expr).filter(*_period_filters(business, start_date, end_date)).scalar()
